...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        writer.add_scalar('epoch/train_loss_ce', batch_ce_loss, epoch_num)
        writer.add_scalar('epoch/train_loss_dice', batch_dice_loss, epoch_num)
        if (epoch_num + 1) % args.eval_interval == 0:
            ...
            with torch.no_grad():
                ...
                writer.add_scalar('epoch/val_loss_ce', batch_ce_loss, epoch_num)
                writer.add_scalar('epoch/val_loss_dice', batch_dice_loss, epoch_num)
                writer.add_scalar('epoch/best_loss', best_loss, epoch_num)
